...
--
-- Host: localhost:3306
-- Generation Time: Dec 02, 2015 at 08:32 AM
...
(1, 'Error', '{{module:error:default}}', 'error', '', '', 1, '', 0, 0, 1, 'none'),
...
(22, 'Breadcrumb Test', '{{module:breadcrumb:default}}\n', 'test/breadcrumb', '', '', 1, '', 1, 0, 0, 'none'),
(24, 'Page Manager', '{{module:pagemanager:default}}\n', 'administration/pagemanager', '', '', 1, '', 1, 0, 0, 'none'),
(25, 'Login', '{{module:user:login}}', 'login', '', '', 1, '', 0, 1, 0, 'none'),
(26, 'Logout', '{{module:user:logout}}', 'account/logout', '', '', 999, '', 0, 0, 0, 'none'),
(27, 'User Details', '{{module:user:details}}', 'account/details', '', '', 1, '', 1, 0, 0, 'none'),
(28, 'Page Permissions', '&lt;p&gt;{{module:pagemanager:permissions}}&lt;br&gt;&lt;/p&gt;', 'administration/permissions', '', '', 0, '', 0, 0, 0, 'none'),
(29, 'System Logs', '&lt;p&gt;{{module:logs:default}}&lt;br&gt;&lt;/p&gt;', 'administration/logs', '', '', 0, '', 0, 0, 0, 'none'),
(30, 'System Settings', '&lt;p&gt;{{module:systemsettings:default}}&lt;br&gt;&lt;/p&gt;', 'administration/settings', '', '', 0, '', 0, 0, 0, 'none'),
(31, 'User Management', '&lt;p&gt;{{module:user:users}}&lt;br&gt;&lt;/p&gt;', 'administration/users', '', '', 0, '', 0, 0, 0, 'none');
