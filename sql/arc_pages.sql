...
(4, 'Page Manager', '{{module:pagemanager:default}}\n', 'administration/pagemanager', '', '', 1, '', 1, 0, 0, 'none'),
(5, 'Login', '{{module:user:login}}', 'login', '', '', 1, '', 1, 1, 0, 'none'),
(6, 'Logout', '{{module:user:logout}}', 'account/logout', '', '', 999, '', 1, 0, 0, 'none'),
(7, 'User Details', '{{module:user:details}}', 'account/details', '', '', 1, '', 1, 0, 0, 'none'),
(8, 'Page Permissions', '&lt;p&gt;{{module:pagemanager:permissions}}&lt;br&gt;&lt;/p&gt;', 'administration/permissions', '', '', 0, '', 1, 0, 0, 'none'),
(9, 'System Logs', '&lt;p&gt;{{module:system:logviewer}}&lt;br&gt;&lt;/p&gt;', 'administration/logs', '', '', 0, '', 1, 0, 0, 'none'),
