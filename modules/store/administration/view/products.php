...
<div class="container">
    ...
    <?php if (arcGetURLData("data3") == null) { ?>
        <div class="text-right">
            <p>
                <button type="button" class="btn btn-primary btn-sm" onclick="window.location = '<?php echo arcGetModulePath() . "products/view/0"; ?>'"><span class="fa fa-plus"></span> New Product</button>
            </p>
        </div>
            ...
            <table class="table table-bordered table-hover">
                ...
                foreach ($products as $product) {
                    ...
                    <tr>
                        <td>
                            <?php
                            echo "<a href=\"" . arcGetModulePath() . "products/view/" . $product->id . "\"><img src=\"" . arcGetPath() . "images/products/";
                        ...
                        <td class="valign">
                            <a href="<?php echo arcGetModulePath() . "products/view/" . $product->id; ?>">
                        ...
                        <td class="valign text-right">
                            <button type="button" class="btn btn-primary btn-xs" title="Edit" onclick="window.location = '<?php echo arcGetModulePath() . "products/view/" . $product->id; ?>'"><span class="fa fa-edit"></span></button>
                            <button type="button" class="btn btn-danger btn-xs" title="Delete" onclick="ajax.send('POST', {action: 'deleteproduct', id: '<?php echo $product->id; ?>'}, '<?php arcGetDispatch(); ?>', updateStatus, true);"><span class="fa fa-close"></span></button>
                        </td>
                    </tr>
                    <?php
                }
        ...
        <?php
    } elseif (arcGetURLData("data3") == "view") {
        $product = new Product();
        $product->getByID(arcGetURLData("data4"));
        ?>
        ...
        <div class="table-responsive">
            ...
            <div class="form-group text-right">
                ...
                <button type="button" class="btn btn-danger" onclick="ajax.send('POST', {action: 'deleteproduct', id: '<?php echo $product->id; ?>'}, '<?php arcGetDispatch(); ?>', updateStatus, true);"><span class="fa fa-remove"></span> Delete</button>
                <button type="button" class="btn btn-primary" onclick="window.location = '<?php echo arcGetModulePath() . "products" ?>'"><span class="fa fa-close"></span> Close</button>
            </div>
        </div>
    <?php } ?>
</div>