        ...
        <div class="panel-body">
            <table class="table table-striped">
                ...
                foreach ($users as $user) {
                    echo '<tr><td>' . $user->id . '</td><td>' . $user->firstname . '</td><td>' . $user->lastname . '</td><td>' . $user->email . '</td><td class="text-right"><a href="' . arcGetModulePath() . 'user/edit/' . $user->id . '"><span class="fa fa-edit"></span> Edit</a>'
        ...
        <div class="panel-body">
            <table class="table table-striped">
                ...
                foreach ($groups as $group) {
                    echo '<tr><td>' . $group->id . '</td><td>' . $group->name . '</td><td class="text-right"><a href="' . arcGetModulePath() . 'group/edit/' . $group->id . '"><span class="fa fa-cog"></span> Permissions</a></td></tr>';
                }
                ?>
            </table>
        </div>
            ...
            <div class="panel-body">
                <table class="table table-striped">
                    ...
                    foreach ($permissions as $permission) {
                        ...
                        echo ' <a href="#" onclick="';
                        ?>
                        ajax.send('POST', {action: 'savepermission', id: '<?php echo $permission->id; ?>', data: '#<?php echo 'permission' . $count; ?>'}, '<?php arcGetDispatch(); ?>', updateStatus, true);
                        <?php
                        echo '"><span class="fa fa-save"></span> Save</a>';
                        echo '</td></tr>';
                        $count++;
                    }
                    ?>
