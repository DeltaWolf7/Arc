                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <a class="btn btn-default" id="addGroupBtn"><i class="fa fa-plus"></i> Add to group</a>
                                    </div>
                                    <div class="col-md-6">
                                        <a class="btn btn-default" id="removeFromGroupBtn"><i class="fa fa-remove"></i> Remove from group</a> 
                                    </div>
                                </div>
                            </div>
