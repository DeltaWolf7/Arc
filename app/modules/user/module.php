...
if (system\Helper::arcGetUser() == null) {
    ...
    system\Helper::arcAddMenuItem("Details", "fa-user", false, system\Helper::arcGetPath() . "user/details", "Profile");
    system\Helper::arcAddMenuItem("Logout", "fa-lock", false, system\Helper::arcGetPath() . "user/logout", "Profile");
}