                ...
                <td class="text-end">
                    <div class="input-group-append">
                        <button class="btn btn-primary" type="button"
                            onclick="viewOrder(<?php echo $order->id; ?>)"><i class="fas fa-search"></i></button>
                        <button class="btn btn-danger" type="button"
                            onclick="deleteOrder(<?php echo $order->id; ?>)"><i class="fas fa-broom"></i></button>
                    </div>
                </td>
            </tr>
            <?php
                ...
                <div class="col-sm-6 align-self-start d-sm-flex justify-content-end text-95">
                    ...
                    ?>
                        ...
                        <div class="my-2">
                            ...
                            <span class="badge bgc-green-d1 text-white badge-pill px-25">
                                <input id="dropship" class="form-control"
                                    value="<?php echo $order->dropshiporder; ?>" />
                            </span>
                        </div>

                        <button class="btn btn-primary btn-block"
                            onclick="saveUpdate(<?php echo $order->id; ?>)">Update</button>
                    </div>
                </div><!-- /.col -->
            </div>
            <div class="mt-4">
