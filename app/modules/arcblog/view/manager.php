    ...
    <div class="card-block">
        ...
        <div role="tabpanel" id="tabs">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="nav-item"><a href="#" class="nav-link active" role="tab" data-toggle="tab" id="posts">Posts</a></li>
                <li role="presentation" class="nav-item"><a href="#" class="nav-link" role="tab" data-toggle="tab" id="categories">Categories</a></li>
            </ul>
            <!-- Tab panes -->
