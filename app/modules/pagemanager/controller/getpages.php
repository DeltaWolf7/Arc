...
if (system\Helper::arcIsAjaxRequest() == true) {
    $table = "<thead><tr><th>SEO Url</th><th>Title</th><th>Icon</th><th class=\"text-right\"><a onclick=\"editPage(0);\" class=\"btn btn-primary btn-xs\"><i class=\"fa fa-plus\"></i> New Page</a></th></tr></thead>";
    $table .= "<tbody>";
