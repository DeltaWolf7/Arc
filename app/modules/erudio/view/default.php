        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="list-group-item"><a href="<?php echo system\Helper::arcGetModulePath() . "partial-words" ?>"><span class="fa fa-book"></span> Partial Words</a></li>
                </ul>
                ...
                <ul class="list-unstyled">
                    <li class="list-group-item"><a href="<?php echo system\Helper::arcGetModulePath() . "2d" ?>"><span class="fa fa-book"></span> 2D Conventional</a></li>
                    <li class="list-group-item"><a href="<?php echo system\Helper::arcGetModulePath() . "3d" ?>"><span class="fa fa-book"></span> 3D</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <ul class="list-unstyled">
                    <li class="list-group-item"><a href="<?php echo system\Helper::arcGetModulePath() . "times-tables" ?>"><span class="fa fa-book"></span> Times Tables</a></li>
                    <li class="list-group-item"><a href="<?php echo system\Helper::arcGetModulePath() . "fractions" ?>"><span class="fa fa-book"></span> Fractions</a></li>
                    <li class="list-group-item"><a href="<?php echo system\Helper::arcGetModulePath() . "algebra" ?>"><span class="fa fa-book"></span> Algebra</a></li>
                </ul>
                <h3>Results</h3>
                <ul class="list-unstyled">
                    <li class="list-group-item"><a href="<?php echo system\Helper::arcGetModulePath() . "results" ?>"><span class="fa fa-book"></span> My Results</a></li>
                    <li class="list-group-item"><a href="<?php echo system\Helper::arcGetModulePath() . "leaderboard" ?>"><span class="fa fa-book"></span> Leaderboard</a></li>
                </ul>
            </div>
        </div>
    </div>
