...
if (system\Helper::arcIsAjaxRequest()) {
    ...
    if (isset($_POST["query"])) {
        $logs = Log::search($_POST["query"], $page, $number);
    } else {
        $logs = Log::getByUserID($_POST["user"], $page, $number);
    }
    ...
    if ($page == 0) {
        ...
        $html .= "<li class=\"page-item\"><a class=\"page-link\" href=\"#\" onclick=\"getItemUser(" . $prevPage . ")\">Previous</a></li>";
    }
    ...
    if ($page == $noPages) {
        ...
        $html .= "<li class=\"page-item\"><a class=\"page-link\" href=\"#\" onclick=\"getItemUser(" . $nextPage . ")\">Next</a></li>";
    }
    $html .= "</ul>"
            . "</nav>";
