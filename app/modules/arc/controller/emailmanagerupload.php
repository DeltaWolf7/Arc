...
if (system\Helper::arcIsAjaxRequest() && count($_FILES) > 0) {
    ...
    if (isset($_FILES['file']['name'])) {
        if (!$_FILES['file']['error']) {
            ...
            $destination = system\Helper::arcGetPath(true) . "assets/emailmanager/" . $filename;

            if (!file_exists(system\Helper::arcGetPath(true) . "assets/emailmanager")) {
                mkdir(system\Helper::arcGetPath(true) . "assets/emailmanager");
            }
            ...
            system\Helper::arcReturnJSON(["path" => system\Helper::arcGetPath() . "assets/emailmanager/" . $filename]);
