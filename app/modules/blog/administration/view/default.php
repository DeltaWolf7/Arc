...
<div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table table-striped">
                    <tr><th>Title</th><th>Category</th><th class="text-right"><button class="btn btn-default btn-sm" onclick=""><span class="fa fa-plus"></span> New Post</button></th></tr>
                    <?php
    ...
    <div class="col-md-5">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table table-striped">
                    <tr><th>Name</th><th class="text-right"><button class="btn btn-default btn-sm" onclick=""><span class="fa fa-plus"></span> New Category</button></th></tr>
                    <?php
                    $cats = BlogCategory::getAllCategories();
                    foreach ($cats as $cat) {
                        ?>
